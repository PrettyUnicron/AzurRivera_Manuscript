...
algorithms for the SCS problem. Most, however, considered a greedy algorithm to solve the SCS problem \cite{Ma2009, Turner1989, Zaritsky2004}.
The reason why greed works for shortest common super string problem was
explored by Ma. He explained the good performance of the greedy algorithm by using the smoothed analysis. That is, for any  given instance $I$ of $SCS$, the average approximation ratio of the greedy algorithm on a small random perturbation of $I$ is $1+o(1)$ \cite{Ma2009}. 
...
In the work of Zaritsky and Sipper, for example, four approaches for 
finding solutions to the SCS problem: a 
standard genetic algorithm, a novel cooperative-co-evolutionary 
algorithm, a benchmark greedy algorithm, and a parallel 
co-evolutionary-greedy approach have been compared \cite{Zaritsky2004}. In the paper,
the co-evolutionary approach produced the best results.

Zaritsky and Sipper's work served as the foundation of this paper. Hence, the following  algorithms, which have been explored and tested in the latter, have been extracted and validated whether they are indeed generating good approximate solution to the SCS problem.

\section{Sample Header for Greedy-SCS}
...
\section{Sample Header for Genetic Algorithm}
